...
*********************************************************************************************************
*/
#define EXTI_LINE0_ENABLE 		(0)		// (0) FOR DISABLE, (1) FOR ENABLE
#define EXTI_LINE1_ENABLE 		(0)		// (0) FOR DISABLE, (1) FOR ENABLE
...
#define EXTI_LINE11_ENABLE 		(1)		// (0) FOR DISABLE, (1) FOR ENABLE
